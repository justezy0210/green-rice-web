...
export const GUIDE_SCENARIOS: GuideScenario[] = [
  ...
  {
    id: 'discovery-block',
    title: 'Heading-date signals to a chr06 review block',
    tabLabel: 'Discovery',
    question: 'Do heading-date signals cluster into one genomic block?',
    summary:
      'This case shows the main value of Discovery: it prevents users from overinterpreting isolated records and instead frames a locus as a review block.',
    steps: [
      {
        label: 'In Discovery, select the chr06 heading/culm locus row',
        detail: 'Enter a locus where multiple trait-linked OG/SV records gather in one genomic window.',
      ...
      {
        label: 'On the detail page, select the Days to Heading trait',
        detail: 'Narrow the attached evidence to the heading-date context.',
      ...
      {
        label: 'Choose EV0007248 or one related OG from the SV pattern area',
        detail: 'Drill down from the block to one SV, one OG, or one local region.',
        inspect: 'Compare whether SV carrier pattern, OG member pattern, and local gene context point in the same direction.',
        result: 'You can prioritize a review locus without claiming a causal gene or variant.',
      },
    ],
    notice: [
      'This is the strongest example for explaining why Discovery exists.',
      'Nearby OG-SV records may represent one regional signal rather than many independent causal events.',
    ],
    outcome: 'A trait question becomes a locus-level hypothesis that can be reviewed through SV, OG, gene, and region evidence.',
    icon: Map,
  },
];
