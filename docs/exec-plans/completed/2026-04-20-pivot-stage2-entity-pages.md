...
- Status: DONE
- Notes: Standalone OG, gene search/detail, cultivar, and dashboard entity
  surfaces are implemented. The planned PAV evidence card evolved into the
  current copy-map/evidence and conservation presentation, so the specific card
  named here is historical.
